...
class CourseSearchTool(Tool):
    ...
    def _format_results(self, results: SearchResults) -> str:
        ...
        for i, (doc, meta) in enumerate(zip(results.documents, results.metadata)):
            ...
            # Track lesson link for the UI
            lesson_link = None
            if results.lesson_links and i < len(results.lesson_links):
                lesson_link = results.lesson_links[i]
...
class CourseOutlineTool(Tool):
    """Tool for retrieving course outlines with full lesson structure"""
    ...
    def execute(self, course_name: str) -> str:
        ...
        """
        # Use the vector store to resolve course name
...
class ToolManager:
    ...
    def get_last_source_links(self) -> list:
        """Get lesson links from the last search operation"""
