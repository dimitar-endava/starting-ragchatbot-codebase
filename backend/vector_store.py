...
class SearchResults:
    ...
    def empty(cls, error_msg: str) -> "SearchResults":
        ...
        return cls(
            documents=[], metadata=[], distances=[], lesson_links=[], error=error_msg
        )
...
class VectorStore:
    ...
    def search(
        ...
        try:
            ...
            search_results.lesson_links = self._get_lesson_links_for_results(
    ...
    def _get_lesson_links_for_results(
