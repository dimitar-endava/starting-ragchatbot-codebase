...
from app import app
from app import rag_system as global_rag_system
...
class TestEndToEndDiagnostic:
    ...
    def test_real_api_query_with_loaded_data(self):
        ...
        try:
            ...
            response, sources, lesson_links = rag_system.query(
    ...
    def test_vector_store_search_with_real_data(self):
        ...
        try:
            ...
            print(
                f"Vector search documents: {search_results.documents[:2]}"
            )  # First 2 docs
            ...
            if search_results.is_empty():
                pytest.fail(
                    "Vector store search returned empty results for generic query"
                )
...
class TestAPIEndpoint:
    ...
    def test_api_endpoint_with_general_question(self):
        ...
        query_data = {"query": "What is 2+2?", "session_id": None}
    ...
    def test_api_endpoint_with_course_question(self):
        ...
        query_data = {"query": "What courses are available?", "session_id": None}
