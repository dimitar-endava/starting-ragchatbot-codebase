...
class TestCourseSearchTool:
    ...
    def test_execute_with_both_filters(self):
        ...
        # Act
        result = self.search_tool.execute("content", course_name="Python", lesson_number=1)
    ...
    def test_execute_empty_results_with_filters(self):
        ...
        # Act
        result = self.search_tool.execute("topic", course_name="Nonexistent Course", lesson_number=5)
        
        # Assert
        assert "No relevant content found in course 'Nonexistent Course' in lesson 5." in result
    ...
    def test_multiple_search_results(self):
        ...
        mock_results = SearchResults(
            documents=[
                ...
                "Second result about programming"
            ],
            metadata=[
