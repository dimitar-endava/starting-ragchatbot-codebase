...
class TestSearchResults:
    ...
    def test_is_empty_false(self):
        ...
        results = SearchResults(
            documents=["doc1"], metadata=[{"title": "test"}], distances=[0.1]
        )
...
class TestVectorStore:
    ...
    def test_search_success(self):
        ...
        self.mock_content_collection.query.assert_called_once_with(
            query_texts=[query], n_results=self.max_results, where=None
        )
    ...
    def test_search_with_course_name_filter(self):
        ...
        mock_chroma_results = {
            ...
            "metadatas": [
                [{"course_title": resolved_course_title, "lesson_number": 2}]
            ],
            "distances": [[0.15]],
        }
        self.mock_content_collection.query.return_value = mock_chroma_results
    ...
    def test_search_with_both_filters(self):
        ...
        mock_chroma_results = {
            ...
            "metadatas": [
                [{"course_title": resolved_course_title, "lesson_number": 1}]
            ],
            "distances": [[0.1]],
        }
        self.mock_content_collection.query.return_value = mock_chroma_results
        ...
        results = self.vector_store.search(
            query, course_name=course_name, lesson_number=lesson_number
        )
    ...
    def test_search_empty_results(self):
        ...
        mock_chroma_results = {"documents": [[]], "metadatas": [[]], "distances": [[]]}
        self.mock_content_collection.query.return_value = mock_chroma_results
    ...
    def test_search_exception_handling(self):
        ...
        # Arrange
        query = "test query"
        self.mock_content_collection.query.side_effect = Exception(
...
class TestVectorStoreIntegration:
    ...
    def test_realistic_course_workflow(self):
        ...
        course = Course(
            ...
            lessons=[
                Lesson(
                    ...
                    lesson_link="http://example.com/python/1",
                ),
                Lesson(
                    lesson_number=2,
                    title="Control Flow",
                    lesson_link="http://example.com/python/2",
                ),
            ],
        )
        self.vector_store.add_course_metadata(course)
        ...
        self.mock_content_collection.query.return_value = {
            "documents": [
                [
                    "Python variables store data values. Python has no command for declaring a variable."
                ]
            ],
            "metadatas": [
                [
