...
class RAGSystem:
    ...
    def query(self, query: str, session_id: Optional[str] = None) -> Tuple[str, List[str], List[Optional[str]]]:
        """
        ...
        Returns:
            Tuple of (response, sources list, lesson links list)
        """
        ...
        # Get sources and lesson links from the search tool
        sources = self.tool_manager.get_last_sources()
        lesson_links = self.tool_manager.get_last_source_links()
        ...
        # Return response with sources and lesson links from tool searches
        return response, sources, lesson_links
